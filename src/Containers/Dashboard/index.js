        ...
        <>
            <div className="col-xl-6 col-lg-9 space-main p-0">
                ...
                <div className="top-sec">
                    <div className="fivehundred" style= {{background: "#fff", padding : "17px 24px"}}>
                        <div className="d-flex gapfor_pro_q">
                            <div className="profile_logo">
                                {/* <img src= {`https://enigma-apps.herokuapp.com/${user.profile_picture}`} alt="error"/> */}
                            </div>
                            <div className="">
                                <h3>{user.username}</h3>
                                <p><span>{user.enigmaId}</span>
                                {/* #</span> <b>123457890 </b> */}
                                </p>
                    ...
                    <div className="oneinityfour">
                        <img src= {qr_code} alt="" className="img-fluid" />
                    </div>
                </div>
